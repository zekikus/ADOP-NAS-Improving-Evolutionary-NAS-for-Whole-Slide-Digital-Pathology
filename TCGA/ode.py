...
if __name__ == "__main__":
    ...
    result_path = "TCGA"
    if os.path.exists("results/TCGA/") == False:
        os.makedirs("results/TCGA/")
    ...
    train_dataset = TCGA_Dataset("Datasets/Train", mode="training", is_nas_phase=True)
    val_dataset = TCGA_Dataset("Datasets/Val", mode="val", is_nas_phase=True)
